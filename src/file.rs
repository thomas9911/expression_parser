...
use crate::{Assignment, Environment, Error, Expression, ExpressionValue, Unassignment};
...
impl ExpressionLine {
    pub fn eval(line: Self, env: &mut Environment) -> EvalResult {
        // env.check_recursion_limit()?;
        check_stack()?;
...
impl ExpressionFile {
    ...
    pub fn eval(file: Self, env: &mut Environment) -> EvalResult {
    ...
    pub fn run(input: &str, env: &mut Environment) -> EvalResult {
